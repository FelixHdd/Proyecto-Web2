                    ...
                    <tbody class="table-group-divider">
                      ...
                      <?php $__currentLoopData = $propuestas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index =>$propuesta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td><a href="<?php echo e(route('propuestas.download',$propuesta->id)); ?>"class="btn btn-secondary">Descargar</a></td>
                          <td><a href="<?php echo e(route('profesores.add', $propuesta->id)); ?>" class="btn btn-primary ">Agregar Comentario</a></div></td>
                          <td><a href="<?php echo e(route('profesores.datos_d', $propuesta->id)); ?>"class="btn btn-danger text-white">Eliminar comentario</a></div></td>
...
<?php echo $__env->make('templates.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sackert\Documents\GitHub\Proyecto-Web2\certamen2.2\resources\views/profesores/showp.blade.php ENDPATH**/ ?>