                    ...
                    <tbody class="table-group-divider">
                      <?php $__currentLoopData = $propuestas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index =>$propuesta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td ><a href="<?php echo e(route('estudiantes.list',$propuesta->id)); ?>" class="btn btn-primary " <?php if($propuesta->estado == "0"): ?>hidden <?php endif; ?>>Revisar Comentario</a></td>
                        </tr> 
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                      
                      <td><a href="<?php echo e(route('estudiantes.create')); ?>" class="btn btn-secondary">Nueva Propuesta</a></td>
                    </tbody>
                </table>
            </div>
        </div>
...
<?php echo $__env->make('templates.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Sackert\Documents\GitHub\Proyecto-Web2\certamen2.2\resources\views/estudiantes/show.blade.php ENDPATH**/ ?>